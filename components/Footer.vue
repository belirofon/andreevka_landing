  ...
  <footer class="bg-primary-800 text-white py-10">
    <div class="container">
        ...
        <div>
          ...
          <ul class="space-y-3">
            <li class="flex items-start">
              ...
              <span class="text-primary-100">посёлок Андреевка, Севастополь, Республика Крым</span>
            </li>
            <li class="flex items-start">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-5 h-5 text-primary-300 mr-3 mt-1">
            ...
            <li class="flex items-start">
              ...
              <span class="text-primary-100">+7 (978) 123-45-67</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="pt-8 mt-8 border-t border-primary-700 text-center">
        <p class="text-primary-300">&copy; {{ new Date().getFullYear() }} Андреевка. Все права защищены.</p>
      </div>
    </div>
  </footer>
</template>