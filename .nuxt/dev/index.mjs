...
const _lazy_6y7T7g = () => Promise.resolve().then(function () { return sendEmail_post$1; });
const _lazy_LwOoCo = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/send-email', handler: _lazy_6y7T7g, lazy: true, middleware: false, method: "post" },
